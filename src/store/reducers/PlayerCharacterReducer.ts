...
const playerCharacterReducer = (state=defaultState, action: PlayerCharacterActionTypes): PlayerCharacter => { 
    ...
    case CHANGE_WORN_ARMOR:
        console.debug(`CHANGE_WORN_ARMOR in reducer ${JSON.stringify(action.WornArmor)}`);
        return {
            ...state,
    ...
    case CHANGE_SPEED:
        console.debug(`CHANGE_SPEED in reducer ${JSON.stringify(action)}`);
        return {
            ...state,
