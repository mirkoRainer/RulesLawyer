...
export const TextEditModalStateSwitch = (actionType: string, state: EntireAppState, dispatch: Dispatch<AppActions>): TextEditModalState => {
    console.debug(`TextEditModalStateSwitch with ${JSON.stringify(actionType, null, 1)}`);
    switch (actionType) {
