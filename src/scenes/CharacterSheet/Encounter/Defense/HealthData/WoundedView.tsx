...
const WoundedView: React.FC<Props> = (props) => {
    ...
    return (
        <Layout style={styles.container}>
            <TouchableOpacity style={styles.container} onPress={handleTapOnWounded}>
                <Text style={styles.text} category='p1'>Wounded:</Text>
                <Text category='h4' style={styles.text}>{props.woundedValue}</Text>
            </TouchableOpacity>
        </Layout>
    );
};
