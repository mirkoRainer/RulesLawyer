...
const InvestigateActivity: React.FC<Props> = (props) => {
    ...
    const description = (
        <Text category="p1" style={styles.text}>
            You seek out information about your surroundings while traveling at
            half speed. You use Recall Knowledge as a secret check to discover
            ...
            action while Investigating, but the GM determines whether the skill
            is relevant to the clues you could find.
        </Text>
    );
