...
A character can live off the land instead, but each day they do, they typically use the Subsist activity to the exclusion of any other downtime activity.</Text>
        </Layout>
    );
