...
} from "./src/PlayerCharacterSheet/1_MainPage/Weapons/WeaponViewProps";
...
export default function CharacterSheet() {
    ...
    const classDCProficiency: ProficiencyProps = {
        ...
        keyAbility: GetAbilityModifierFromScores(
            example.playerCharacter.class.keyAbility,
            example.playerCharacter.abilityScores
        ),
        ...
        itemBonus: Bonus.GetBonusFor(
            "classDc",
            BonusType.Item,
            example.playerCharacter.bonuses
        ),
        is10base: true,
    };
    ...
    switch (example.playerCharacter.wornArmor.Category) {
        case ArmorCategory.Unarmored: {
            wornArmorProficiency = prop(
                example.playerCharacter.armorProficiencies,
                "unarmored"
            );
            break;
        }
